...
import kk.techbytecare.customcamera.Adapter.StickerAdapter;
import kk.techbytecare.customcamera.R;
import kk.techbytecare.customcamera.Remote.IMainActivity;

public class ViewStickersFragment extends Fragment implements StickerAdapter.RecyclerViewClickListener,
    ...
    private void getStickers(){
        ...
        mStickers.add(getActivity().getResources().getDrawable(R.mipmap.ic_undo_small));
