package kk.techbytecare.customcamera;
...
import kk.techbytecare.customcamera.Fragments.CameraFragment;
import kk.techbytecare.customcamera.Fragments.ViewStickersFragment;
...
public class MainActivity extends AppCompatActivity implements IMainActivity {
    ...
    public void hideStillshotWidgets() {
        CameraFragment camera2Fragment = (CameraFragment) getSupportFragmentManager().findFragmentByTag(getString(R.string.fragment_camera2));
